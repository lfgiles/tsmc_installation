...
# ================================================
array set ::g_tho_tbl ""
set ::g_tho_tbl(rhim_nw)    {624.3  -0.0146148  -0.0248614  0}
set ::g_tho_tbl(rhim_psub)  {624.3  -0.0146148  -0.0248614  0}
...
## ===========================================================================
set ::g_Itest_1st   1300    ; # ESD.CD.1gu, primary ESD discharge path current (1.3A)
set ::g_Itest_2nd     12    ; # ESD.CD.2gu, secondary ESD discharge path current (12mA)
...
set ::g_Rmax(ESD.DISTP2P.1gu)     0.8   ; # resistance of ESD diode to power/ground Pad through core power-clamp
...
if { ![catch {tvf::svrf_var CDM_14A}] && [tvf::svrf_var CDM_14A] } {
    ...
    set ::g_Itest_1st                 3500  ; # ESD.CD.1gu, primary ESD discharge path current (3.5A)
    set ::g_Itest_2nd                   35  ; # ESD.CD.2gu, secondary ESD discharge path current (35mA)
    ...
    set ::g_Itest_1st                 2400  ; # ESD.CD.1gu, primary ESD discharge path current (2.4A)
    set ::g_Itest_2nd                   25  ; # ESD.CD.2gu, secondary ESD discharge path current (25mA)
    ...
    set ::g_Itest_1st                 1800  ; # ESD.CD.1gu, primary ESD discharge path current (1.8A)
    set ::g_Itest_2nd                   20  ; # ESD.CD.2gu, secondary ESD discharge path current (20mA)
