...
set ::g_1st_esd(hia_p)     {HIA.3g       >=  9.1}           ; # total HIA diode perimeter
set ::g_1st_esd(hia_a)     {HIA.3.1g     >=  0.7}            ; # total HIA diode area #updated TEG
set ::g_1st_esd(lc_hia_w)  {ESD.LC.1g    ==  0.157}         ; # LC HIA diode Active region width
set ::g_1st_esd(lc_hia_p)  {ESD.LC.3g    >=  9.1 {$p - $l/2}} ; # total LC HIA diode perimeter
set ::g_1st_esd(lc_hia_a)  {ESD.LC.3.1g  >=  0.7}            ; # total LC HIA diode area -->tbd
...
set ::g_pc(group_w)         {ESD.40.3.1gU  >=  172}          ; # total finger width of unit cell #updated to 400->7128 15/12/2020 according K.Domanski,->200 -> 172 updated NR 23/08/2021
...
#   ESD.CDM.*
# ---------------------------------------
set ::g_hc_pc(hia_a)        {ESD.CDM.4gU    >=  0.7}     ; # extra reverse HIA diode area for cascoded(3.3V) power-clamp (HIA.3.1g)
...
set ::g_hc_glo_b2b(hia_p)   {ESD.CDM.B.1gU  >=  18.2}    ; # total HIA diode perimeter (HIA.3g) #updated to 180->17 01/04/2020 according K.Domanski, update NR; update to align on 9.4 from 12 29/09/2020
...
set ::g_hc_cdm_b2b(hia_p)   {ESD.CDM.B.2gU  >=  18.2}    ; # total HIA diode perimeter (HIA.3g)  #updated to 180->9.4 20/05/2020 according K.Domanski, update NR
...
set ::g_b2b(hia_p)  {ESD.15gU  >=  18.2} ; # total HIA diode perimeter (HIA.3g) #updated to 180->18.2 15/12/2020 according K.Domanski, update NR
...
## ===========================================================================
set ::g_Itest(ESD.CD.1gu) 58  ; # ESD.CD.1gu, primary ESD discharge path current (1.3A)#update TEG CDM 35V 220mA
set ::g_Itest(ESD.CD.1.1gu) 58 ; # ESD.CD.1.1gu, reverse HIA diode discharge path current (1.3A))#update TEG
...
set ::g_Rmax(ESD.CDM.P.1gu)       70.7  ; # resistance of IOPAD to Primary ESD #)#update TEG
set ::g_Rmax(ESD.CDM.P.1.1gu)     3.5   ; # resistance of Primary ESD to closest Pad #)#update TEG
set ::g_Rmax(ESD.CDM.P.2gu)       2.55   ; # resistance of Primary ESD to power-clamp #)#update TEG
set ::g_Rmax(ESD.CDM.P.2.1gu)   2.55   ; # resistance of Primary ESD to reverse diode )#update TEG -->tbf
set ::g_Rmax(ESD.CDM.P.3gu)       3.5   ; # resistance of Power/Ground pad to core (0.75V) power-clamp #)#update TEG
set ::g_Rmax(ESD.CDM.P.4gu)       3.5   ; # resistance of Power/Ground pad to IO (1.8V) power-clamp #)#update TEG
set ::g_Rmax(ESD.CDM.P.5gu)       3.5   ; # resistance of Power/Ground pad to cascoded (3.3V) power-clamp #)#update TEG
...
set ::g_Rmax(ESD.CDM.P.8gu)       3.5   ; # resistance of back-to-back (B2B) diode to ground pad #)#update TEG
set ::g_Rmax(ESD.CDM.P.9gu)       3.5   ; # resistance of back-to-back (B2B) diode to power-clamp #)#update TEG
...
set ::g_Rmax(ESD.DISTP2P.1gu)     2.0   ; # resistance of ESD diode to power/ground Pad through core power-clamp #updated 23/01/2020 according H.Dhakad #updated 25/07/2020 according K.Domanski, original: 0.8
