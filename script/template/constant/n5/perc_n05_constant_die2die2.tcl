...
##         Device Table
## ===========================================================================
set ::g_core_nmos_ncs {nch_svt_mac nch_ulvt_mac nch_ulvtll_mac nch_lvt_mac nch_lvtll_mac nch_elvt_mac}

set ::g_core_pmos_pcs {pch_svt_mac pch_ulvt_mac pch_ulvtll_mac pch_lvt_mac pch_lvtll_mac pch_elvt_mac}
...
set ::g_1st_esd(hia_p)     {HIA.3g       >=  28.6}           ; # total HIA diode perimeter#updated to 180->14.32 22/12/2020 according K.Domanski NR update
set ::g_1st_esd(hia_a)     {HIA.3.1g     >=  3.2188}            ; # total HIA diode area #updated to 36->3.2188 22/12/2020 according K.Domanski NR update
set ::g_1st_esd(lc_hia_p)  {ESD.LC.3g    >=   0}            ; # total LC HIA diode perimeter
set ::g_1st_esd(lc_hia_a)  {ESD.LC.3.1g  >=  3.2188}            ; # total LC HIA diode area#updated to 18->3.2188 22/12/2020 according K.Domanski NR update
...
#   ESD.CDM.*
# ---------------------------------------
set ::g_hc_pc(hia_a)        {ESD.CDM.4gU    >=  3.2188}     ; # extra reverse HIA diode area for cascoded(1.8V) power-clamp (HIA.3.1g)#updated to 36->14.32 22/12/2020 according K.Domanski, update NR
...
set ::g_hc_glo_b2b(hia_p)   {ESD.CDM.B.1gU  >=  28.6}    ; # total HIA diode perimeter (HIA.3g) #updated to 180->14.32 22/12/2020 according K.Domanski, update NR
...
set ::g_hc_cdm_b2b(hia_p)   {ESD.CDM.B.2gU  >=  28.6}    ; # total HIA diode perimeter (HIA.3g) #updated to 180->14.32 22/12/2020 according K.Domanski, update NR
...
set ::g_b2b(hia_p)  {ESD.15gU  >=  28.6} ; # total HIA diode perimeter (HIA.3g) #updated to 180->14.32 22/12/2020 according K.Domanski, update NR
...
## ===========================================================================
set ::g_Itest(ESD.CD.1gu) 73  ; # ESD.CD.1gu, primary ESD discharge path current (1.3A)#updated for D2D by TEG ESD
set ::g_Itest(ESD.CD.1.1gu) 73 ; # ESD.CD.1.1gu, reverse HIA diode discharge path current (1.3A)#updated for D2D by TEG ESD
...
set ::g_Rmax(ESD.CDM.P.1.0.1gu)   0.7  ; # resistance of IOPAD to Primary ESD pull-down diode (R3)#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.1.0.2gu)   0.7  ; # resistance of IOPAD to Primary ESD pull-up diode (R1)#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.1.0.3gu)   0.7  ; # resistance of IOPAD to Primary ESD snapback NMOS (R3)#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.1.1.0.1gu) 3.5  ; # resistance of Primary ESD pull-down diode to closest Pad#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.1.1.0.2gu) 3.5  ; # resistance of Primary ESD pull-up diode to closest Pad#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.1.1.0.3gu) 3.5  ; # resistance of Primary ESD snapback NMOS to closest Pad#updated for D2D by TEG ESD
...
set ::g_Rmax(ESD.CDM.P.2.0.1gu)   2.55  ; # resistance of Primary ESD pull-down diode to power-clamp#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.2.0.2gu)   2.55  ; # resistance of Primary ESD pull-up diode to power-clamp#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.2.0.3gu)   2.55  ; # resistance of Primary ESD snapback NMOS to power-clamp#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.2.1gu)     2.55  ; # resistance of Primary ESD 2-stage snapback NMOS to reverse diode#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.3.0.1gu)   2  ; # resistance of Ground pad to core power-clamp#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.3.0.2gu)   2  ; # resistance of Power pad to core power-clamp#updated for D2D by TEG ESD
...
if { ![catch {tvf::svrf_var CDM_9A}] && [tvf::svrf_var CDM_9A] } {
    ...
    set ::g_Rmax(ESD.CDM.P.2.0.1gu)   2.5  ; # resistance of Primary ESD pull-down diode to power-clamp
    set ::g_Rmax(ESD.CDM.P.2.0.2gu)   2.5  ; # resistance of Primary ESD pull-up diode to power-clamp
    set ::g_Rmax(ESD.CDM.P.2.0.3gu)   2.5  ; # resistance of Primary ESD snapback NMOS to power-clamp
    set ::g_Rmax(ESD.CDM.P.2.1gu)     2.5  ; # resistance of Primary ESD 2-stage snapback NMOS to reverse diode
