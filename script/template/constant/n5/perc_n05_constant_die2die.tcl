...
set ::g_1st_esd(hia_p)     {HIA.3g       >=  14.32}           ; # total HIA diode perimeter#updated to 180->14.32 22/12/2020 according K.Domanski NR update
...
set ::g_hc_glo_b2b(hia_p)   {ESD.CDM.B.1gU  >=  14.32}    ; # total HIA diode perimeter (HIA.3g) #updated to 180->14.32 22/12/2020 according K.Domanski, update NR
...
set ::g_hc_cdm_b2b(hia_p)   {ESD.CDM.B.2gU  >=  14.32}    ; # total HIA diode perimeter (HIA.3g) #updated to 180->14.32 22/12/2020 according K.Domanski, update NR
...
set ::g_b2b(hia_p)  {ESD.15gU  >=  14.32} ; # total HIA diode perimeter (HIA.3g) #updated to 180->14.32 22/12/2020 according K.Domanski, update NR
...
## ===========================================================================
set ::g_Itest(ESD.CD.1gu) 80  ; # ESD.CD.1gu, primary ESD discharge path current (1.3A)#updated for D2D by TEG ESD
set ::g_Itest(ESD.CD.1.1gu) 80 ; # ESD.CD.1.1gu, reverse HIA diode discharge path current (1.3A)#updated for D2D by TEG ESD
...
set ::g_Rmax(ESD.CDM.P.2.0.1gu)   3.5  ; # resistance of Primary ESD pull-down diode to power-clamp#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.2.0.2gu)   3.5  ; # resistance of Primary ESD pull-up diode to power-clamp#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.2.0.3gu)   3.5  ; # resistance of Primary ESD snapback NMOS to power-clamp#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.2.1gu)     3.5  ; # resistance of Primary ESD 2-stage snapback NMOS to reverse diode#updated for D2D by TEG ESD
...
set ::g_Rmax(ESD.CDM.P.4.0.1gu)   2  ; # resistance of Ground pad to IO power-clamp#updated for D2D by TEG ESD
set ::g_Rmax(ESD.CDM.P.4.0.2gu)   2  ; # resistance of Power pad to IO power-clamp#updated for D2D by TEG ESD
