...
set ::g_Rmax(ESD.CDM.P.3.0.1gu)   0.1  ; # resistance of Ground pad to core power-clamp
set ::g_Rmax(ESD.CDM.P.3.0.2gu)   0.1  ; # resistance of Power pad to core power-clamp
set ::g_Rmax(ESD.CDM.P.4.0.1gu)   0.2  ; # resistance of Ground pad to IO power-clamp
set ::g_Rmax(ESD.CDM.P.4.0.2gu)   0.2  ; # resistance of Power pad to IO power-clamp
set ::g_Rmax(ESD.CDM.P.5.0.1gu)   0.2  ; # resistance of Ground pad to cascoded power-clamp
set ::g_Rmax(ESD.CDM.P.5.0.2gu)   0.2  ; # resistance of Power pad to cascoded power-clamp
...
set ::g_Rmax(ESD.DISTP2P.1.0gu)     4.2   ; # resistance of IOPAD to Primary ESD (R0)
set ::g_Rmax(ESD.DISTP2P.1.0.1gu)   1.26  ; # resistance of ESD diode to power/ground Pad through core power-clamp
set ::g_Rmax(ESD.DISTP2P.1.0.2gu)   1.26  ; # resistance of ESD diode to power/ground Pad through core power-clamp
set ::g_Rmax(ESD.DISTP2P.1.1.0gu)   4.2   ; # resistance of IOPAD to Primary ESD (R0)
set ::g_Rmax(ESD.DISTP2P.1.1.0.1gu) 1.46  ; # resistance of ESD diode to power/ground Pad through IO power-clamp
set ::g_Rmax(ESD.DISTP2P.1.1.0.2gu) 1.46  ; # resistance of ESD diode to power/ground Pad through IO power-clamp
set ::g_Rmax(ESD.DISTP2P.1.2.0gu)   4.2   ; # resistance of IOPAD to Primary ESD (R0)
set ::g_Rmax(ESD.DISTP2P.1.2.0.1gu) 1.06  ; # resistance of ESD diode inside LC_DMY to power/ground Pad through core power-clamp
set ::g_Rmax(ESD.DISTP2P.1.2.0.2gu) 1.06  ; # resistance of ESD diode inside LC_DMY to power/ground Pad through core power-clamp
set ::g_Rmax(ESD.DISTP2P.1.3.0gu)   4.2   ; # resistance of IOPAD to Primary ESD (R0)
set ::g_Rmax(ESD.DISTP2P.1.3.0.1gu) 1.26  ; # resistance of ESD diode inside LC_DMY to power/ground Pad through IO power-clamp
set ::g_Rmax(ESD.DISTP2P.1.3.0.2gu) 1.26  ; # resistance of ESD diode inside LC_DMY to power/ground Pad through IO power-clamp
