...
##         Device Table
## ===========================================================================
set ::g_core_nmos_ncs {nch_svt_mac nch_svtll_mac nch_ulvt_mac nch_ulvtll_mac nch_lvt_mac nch_lvtll_mac nch_elvt_mac nch_xlvt_mac}

set ::g_core_pmos_pcs {pch_svt_mac pch_svtll_mac pch_ulvt_mac pch_ulvtll_mac pch_lvt_mac pch_lvtll_mac pch_elvt_mac pch_xlvt_mac}
...
set ::g_pc(ron_core)    {26900 nfin}
set ::g_pc(ron_12)      {32400 nfin}
...
set ::g_hc_dd_vic(mn_io_gnd_wxr)           [list ESD.CDM.2gU >= {0.135 1031 0 1729}             ]
set ::g_hc_dd_vic(mn_io_pwr_wxr)           [list ESD.CDM.2gU >= {0.135 636 0 1113}              ]
set ::g_hc_dd_vic(mp_io_gnd_wxr)           [list ESD.CDM.2gU >= {0.135 5395 0 63171}            ]
set ::g_hc_dd_vic(mp_io_pwr_wxr)           [list ESD.CDM.2gU >= {0.135 3219 0 37435}            ]
set ::g_hc_dd_vic(mn_core_gnd_wxr)         [list ESD.CDM.2gU >= {0.054 964 0.02 1206 0 29643}   ]
set ::g_hc_dd_vic(mn_core_pwr_wxr)         [list ESD.CDM.2gU >= {0.054 701 0.02 895 0 22493}    ]
set ::g_hc_dd_vic(mp_core_gnd_wxr)         [list ESD.CDM.2gU >= {0.054 6757 0.02 24378 0 40196} ]
set ::g_hc_dd_vic(mp_core_pwr_wxr)         [list ESD.CDM.2gU >= {0.054 4991 0.02 18518 0 30321} ]
...
set ::g_hc_dd_vic(cas_mn_io_gnd_wxr)       [list ESD.CDM.2gU >= {0.135 5004 0 5004}             "topo_ldl"]
set ::g_hc_dd_vic(cas_mn_io_pwr_wxr)       [list ESD.CDM.2gU >= {0.135 2196 0 2196}             "topo_ldl"]
set ::g_hc_dd_vic(cas_mp_io_gnd_wxr)       [list ESD.CDM.2gU >= {0.135 14098 0 14098}           "topo_ldl"]
set ::g_hc_dd_vic(cas_mp_io_pwr_wxr)       [list ESD.CDM.2gU >= {0.135 0 0 0}                   "topo_ldl"]
set ::g_hc_dd_vic(cas_mm_io_gnd_wxr)       [list ESD.CDM.2gU >= {0.135 5395 0 63171}            ]
set ::g_hc_dd_vic(cas_mm_io_pwr_wxr)       [list ESD.CDM.2gU >= {0.135 3219 0 37435}            ]
set ::g_hc_dd_vic(cas_mn_core_gnd_wxr)     [list ESD.CDM.2gU >= {0.054 4702 0.02 4702 0 26086}  ]
set ::g_hc_dd_vic(cas_mn_core_pwr_wxr)     [list ESD.CDM.2gU >= {0.054 861 0.02 861 0 16826}    ]
set ::g_hc_dd_vic(cas_mp_core_gnd_wxr)     [list ESD.CDM.2gU >= {0.054 981 0.02 8628 0 11757}   ]
set ::g_hc_dd_vic(cas_mp_core_pwr_wxr)     [list ESD.CDM.2gU >= {0.054 69 0.02 3537 0 6128}     ]
set ::g_hc_dd_vic(cas_mm_core_gnd_wxr)     [list ESD.CDM.2gU >= {0.054 6757 0.02 24378 0 40196} ]
set ::g_hc_dd_vic(cas_mm_core_pwr_wxr)     [list ESD.CDM.2gU >= {0.054 4991 0.02 18518 0 30321} ]
set ::g_hc_dd_vic(cas_mn_mix_gnd_wxr)      [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(cas_mn_mix_pwr_wxr)      [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(cas_mp_mix_gnd_wxr)      [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(cas_mp_mix_pwr_wxr)      [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(cas_mm_mix_gnd_wxr)      [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(cas_mm_mix_pwr_wxr)      [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
...
set ::g_hc_dd_vic(cas_mn_mix_wxr)          [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(cas_mp_mix_wxr)          [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(cas_mm_mix_wxr)          [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
...
set ::g_hc_dd_vic(stack_mn_io_gnd_wxr)     [list ESD.CDM.2gU >= {0.135 8989 0 8989}             "topo_ldl"]
set ::g_hc_dd_vic(stack_mn_io_pwr_wxr)     [list ESD.CDM.2gU >= {0.135 0 0 1011}                "topo_ldl"]
set ::g_hc_dd_vic(stack_mp_io_gnd_wxr)     [list ESD.CDM.2gU >= {0.135 1053 0 1053}             "topo_ldl"]
set ::g_hc_dd_vic(stack_mp_io_pwr_wxr)     [list ESD.CDM.2gU >= {0.135 0 0 0}                   "topo_ldl"]
set ::g_hc_dd_vic(stack_mm_io_gnd_wxr)     [list ESD.CDM.2gU >= {0.135 14098 0 63171}           ]
set ::g_hc_dd_vic(stack_mm_io_pwr_wxr)     [list ESD.CDM.2gU >= {0.135 3219 0 37435}            ]
set ::g_hc_dd_vic(stack_mn_core_gnd_wxr)   [list ESD.CDM.2gU >= {0.054 4702 0.02 4702 0 26086}  "topo_ldl"]
set ::g_hc_dd_vic(stack_mn_core_pwr_wxr)   [list ESD.CDM.2gU >= {0.054 861 0.02 861 0 16826}    "topo_ldl"]
set ::g_hc_dd_vic(stack_mp_core_gnd_wxr)   [list ESD.CDM.2gU >= {0.054 981 0.02 8628 0 11757}   "topo_ldl"]
set ::g_hc_dd_vic(stack_mp_core_pwr_wxr)   [list ESD.CDM.2gU >= {0.054 69 0.02 3537 0 6128}     "topo_ldl"]
set ::g_hc_dd_vic(stack_mm_core_gnd_wxr)   [list ESD.CDM.2gU >= {0.054 6757 0.02 24378 0 40196} ]
set ::g_hc_dd_vic(stack_mm_core_pwr_wxr)   [list ESD.CDM.2gU >= {0.054 4991 0.02 18518 0 30321} ]
set ::g_hc_dd_vic(stack_mn_mix_gnd_wxr)    [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(stack_mn_mix_pwr_wxr)    [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(stack_mp_mix_gnd_wxr)    [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(stack_mp_mix_pwr_wxr)    [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(stack_mm_mix_gnd_wxr)    [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(stack_mm_mix_pwr_wxr)    [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(stack_mn_io_wxr)         [list ESD.CDM.2gU >= {0.135 8989 0 8989}             "topo_ldl"]
set ::g_hc_dd_vic(stack_mp_io_wxr)         [list ESD.CDM.2gU >= {0.135 1053 0 1053}             "topo_ldl"]
set ::g_hc_dd_vic(stack_mm_io_wxr)         [list ESD.CDM.2gU >= {0.135 14098 0 63171}           ]
set ::g_hc_dd_vic(stack_mn_core_wxr)       [list ESD.CDM.2gU >= {0.054 4702 0.02 4702 0 26086}  "topo_ldl"]
set ::g_hc_dd_vic(stack_mp_core_wxr)       [list ESD.CDM.2gU >= {0.054 981 0.02 8628 0 11757}   "topo_ldl"]
set ::g_hc_dd_vic(stack_mm_core_wxr)       [list ESD.CDM.2gU >= {0.054 6757 0.02 24378 0 40196} ]
set ::g_hc_dd_vic(stack_mn_mix_wxr)        [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(stack_mp_mix_wxr)        [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
set ::g_hc_dd_vic(stack_mm_mix_wxr)        [list ESD.CDM.2gU >= {0.054 0 0.02 0 0 0}            ]
...
# ================================================
array set ::g_tho_tbl ""
#set ::g_tho_tbl(rhim)   {615.5156   -0.033421   0.0035839   0}
...
set ::g_ldl_var(ESD.CDM.C.2gU)    5000  ; # Power-Clamp Size up #intel update 26/07/2019 according K.Domanski
set ::g_ldl_var(ESD.CDM.C.3.1gU)  5000  ; # Power-Clamp Size up #intel update 26/07/2019 according K.Domanski
set ::g_ldl_var(ESD.CDM.C.3.2gU)  5000  ; # Power-Clamp Size up #intel update 26/07/2019 according K.Domanski
...
set ::g_Rmax(ESD.CDM.P.1.2gu)   0.1   ; # resistance of Primary ESD stacked diode
...
set ::g_Rmax(ESD.CDM.P.4gu)     0.2   ; # resistance of Power/Ground pad to IO (1.2V) power-clamp
set ::g_Rmax(ESD.CDM.P.5gu)     0.2   ; # resistance of Power/Ground pad to cascoded (1.8V/3.3V) power-clamp
...
set ::g_Rmax(ESD.DISTP2P.1gu)   0.75  ; # resistance of ESD diode to power/ground Pad through core power-clamp
set ::g_Rmax(ESD.DISTP2P.1.1gu) 0.95  ; # resistance of ESD diode to power/ground Pad through IO power-clamp
set ::g_Rmax(ESD.DISTP2P.1.2gu) 0.55  ; # resistance of ESD diode inside LC_DMY to power/ground Pad through core power-clamp
set ::g_Rmax(ESD.DISTP2P.1.3gu) 0.75  ; # resistance of ESD diode inside LC_DMY to power/ground Pad through IO power-clamp
...
if { ![catch {tvf::svrf_var CDM_9A}] && [tvf::svrf_var CDM_9A] } {
    ...
    set ::g_Rmax(ESD.LCP2P.2gu)       0.05  ; # resistance of Primary ESD dual diode inside LC_DMY to power-clamp
    ...
    set ::g_Rmax(ESD.CDM.P.1.2gu)     0.05  ; # resistance of Primary ESD stacked diode
    set ::g_Rmax(ESD.CDM.P.2gu)       0.17  ; # resistance of Primary ESD to power-clamp
    set ::g_Rmax(ESD.CDM.P.3gu)       0.05  ; # resistance of Power/Ground pad to core (0.75V) power-clamp
    set ::g_Rmax(ESD.CDM.P.4gu)       0.1   ; # resistance of Power/Ground pad to IO (1.2V) power-clamp
    set ::g_Rmax(ESD.CDM.P.5gu)       0.1   ; # resistance of Power/Ground pad to cascoded (1.8V) power-clamp
    ...
    set ::g_Rmax(ESD.DISTP2P.1gu)     0.39  ; # resistance of ESD diode to power/ground Pad through core power-clamp
    set ::g_Rmax(ESD.DISTP2P.1.1gu)   0.50  ; # resistance of ESD diode to power/ground Pad through IO power-clamp
    set ::g_Rmax(ESD.DISTP2P.1.2gu)   0.32  ; # resistance of ESD diode inside LC_DMY to power/ground Pad through core power-clamp
    set ::g_Rmax(ESD.DISTP2P.1.3gu)   0.43  ; # resistance of ESD diode inside LC_DMY to power/ground Pad through IO power-clamp
...
## ===========================================================================
    ...
    set ::g_Rmax(ESD.LCP2P.2gu)       0.07  ; # resistance of Primary ESD dual diode inside LC_DMY to power-clamp
    ...
    set ::g_Rmax(ESD.CDM.P.1.2gu)     0.07  ; # resistance of Primary ESD stacked diode
    ...
    set ::g_Rmax(ESD.CDM.P.4gu)       0.14  ; # resistance of Power/Ground pad to IO (1.2V) power-clamp
    set ::g_Rmax(ESD.CDM.P.5gu)       0.14  ; # resistance of Power/Ground pad to cascoded (1.8V) power-clamp
    set ::g_Rmax(ESD.CDM.P.7gu)       1.4   ; # resistance of I/O power-clamp to power-clamp
    set ::g_Rmax(ESD.CDM.P.7.1.1gu)   1.0   ; # resistance of Core power-clamp to power-clamp on power net
    set ::g_Rmax(ESD.CDM.P.7.1.2gu)   0.7   ; # resistance of Core power-clamp to power-clamp on ground net
    set ::g_Rmax(ESD.CDM.P.7.2gu)     1.4   ; # resistance of Cascoded power-clamp to power-clamp
    ...
    set ::g_Rmax(ESD.DISTP2P.1gu)     0.49  ; # resistance of ESD diode to power/ground Pad through core power-clamp
    set ::g_Rmax(ESD.DISTP2P.1.1gu)   0.65  ; # resistance of ESD diode to power/ground Pad through IO power-clamp
    set ::g_Rmax(ESD.DISTP2P.1.2gu)   0.36  ; # resistance of ESD diode inside LC_DMY to power/ground Pad through core power-clamp
    set ::g_Rmax(ESD.DISTP2P.1.3gu)   0.52  ; # resistance of ESD diode inside LC_DMY to power/ground Pad through IO power-clamp
