#!/usr/bin/env bash
# Usage $ build_die2die_280.sh n6 v0.0.1 11M_2X1Ya3Y2Yy2R 1P11M_2X_hv_1Ya_h_3Y_vhv_2Yy2R
#used for Elasti /nfs/site/proj/libdev/esdlusyn/workareas2/n5/rhaeussl.v1.1.8/opuslib/wk_rhaeussl/D2D4MIG_300mA_v02
...
cp -R ${_path_deck}/tsmc_lib ${_path_deck}/tsmc_lib_die2die2

#`perc_*_constant.tcl` already contains the first level modification
_constant_file_relaxed=${_path_deck}/tsmc_lib_die2die2/perc_*_constant.tcl

## ESD relaxed constant values (die2die)
_constant_with_intel_relaxed_mod=script/template/constant/${NODE}/perc_${NODE_NB}_constant_die2die2.tcl
...
for file_rules in ${_path_deck}/tsmc_lib_die2die2/perc*.rules; do
    for i in "${arr_topo[@]}"
    do
...
declare -a arr_p2pcd=( "-rulecheck ESD.CD.2gu"
    ...
    "-rulecheck ESD.14.3gu:dio:up"
    "-rulecheck ESD.14.3gu:dio:dn"
    "-rulecheck ESD.14.3gu:mos:dn"
    "-rulecheck ESD.14.3.1gu:dio"
    "-rulecheck ESD.14.3.2gu"
    "-rulecheck ESD.14.3.1gu:mos"
    "-rulecheck ESD.14.4gu"
    "-rulecheck ESD.14.5gu:up"
    "-rulecheck ESD.14.5gu:dn"
    ...
    "-rulecheck ESD.LCP2P.1gu:up"
    "-rulecheck ESD.LCP2P.1gu:dn"
    "-rulecheck ESD.LCP2P.2gu:up"
    "-rulecheck ESD.LCP2P.2gu:dn"
...
sed -i "${_line_to_change}i\\/\/#DEFINE IO_DIE2DIE_CDM_35V_280mA   //Intel switch for Die2Die protection more info on goto/ESD" ${_path_component}/RSF_perc_esd_template

# Add path to the relaxed runset

_line_to_change=`sed -ne '/#IFDEF CDM_/=;/#IFDEF CDM_/q' ${_path_component}/RSF_perc_esd_template`
sed -i "${_line_to_change}i\#IFDEF IO_DIE2DIE_CDM_35V_280mA //add by Intel\n  INCLUDE \"./tsmc_lib_die2die2/perc_${NODE_NB}.rules\"\n#ELSE\n" ${_path_component}/RSF_perc_esd_template
sed -i '$i#ENDIF //end IO_DIE2DIE_CDM_35V_280mA' ${_path_component}/RSF_perc_esd_template
