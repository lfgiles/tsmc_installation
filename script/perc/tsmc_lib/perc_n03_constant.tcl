...
set ::g_ldl_var(ESD.CDM.C.2gU)    1500  ; # Power-Clamp Size up
set ::g_ldl_var(ESD.CDM.C.3.1gU)  1500  ; # Power-Clamp Size up
set ::g_ldl_var(ESD.CDM.C.3.2gU)  1500  ; # Power-Clamp Size up
...
if { ![catch {tvf::svrf_var CDM_9A}] && [tvf::svrf_var CDM_9A] } {
    ...
    set ::g_ldl_var(ESD.CDM.C.5gU)     410  ; # mos connected to small power/ground domain to power-clamp distance
...
## ===========================================================================
    ...
    set ::g_ldl_var(ESD.CDM.C.2gU)    1350  ; # mos connected to power/ground to power-clamp distance
    set ::g_ldl_var(ESD.CDM.C.3.1gU)  1350  ; # core mos between power/ground to power-clamp distance
    set ::g_ldl_var(ESD.CDM.C.3.2gU)  1350  ; # io mos between power/ground to power-clamp distance
